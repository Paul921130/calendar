    ...
    _createClass(Module, [{
        ...
        value: function showMonthDate() {
            ...
            for (var i = 0; i <= 2; i++) {
                ...
                var monthsTitle = '<li class="tab">' + '<a href="#">' + '<span>' + nextMonthMo + '</span>' + '</a>' + '</li>';
